...
RULES = [
    {"name": "D_zdiv_nope_high_SHORT_30m", "direction": "SHORT", "horizon_min": 30, "conditions": [{"feature": "zdiv_nope_state", "op": "eq", "value": "strong_pos", "value_hi": null}], "composite_score": 76.8491, "support": 130, "win_rate": 0.7846, "mes_net_expectancy_usd": 54.93, "mes_median_mfe_pts": 23.73, "mes_median_mae_pts": 3.95, "wf_stability": 1.0, "neighbor_robust": true},
    ...
    {"name": "D_zdiv_net_prem_high_SHORT_15m", "direction": "SHORT", "horizon_min": 15, "conditions": [{"feature": "zdiv_net_prem_state", "op": "eq", "value": "strong_pos", "value_hi": null}], "composite_score": 55.2278, "support": 149, "win_rate": 0.6309, "mes_net_expectancy_usd": 64.95, "mes_median_mfe_pts": 12.19, "mes_median_mae_pts": 6.68, "wf_stability": 1.0, "neighbor_robust": true},
    ...
    {"name": "L_otm_put_pct_low_LONG_30m", "direction": "LONG", "horizon_min": 30, "conditions": [{"feature": "otm_put_pct", "op": "lt", "value": 0.2, "value_hi": null}], "composite_score": 44.7239, "support": 190, "win_rate": 0.6737, "mes_net_expectancy_usd": -8.28, "mes_median_mfe_pts": 42.84, "mes_median_mae_pts": 5.27, "wf_stability": 0.5, "neighbor_robust": true},
